...
(function() {
  var F, argumentError, delimiters, importOrder, module, rgxNonWhitespace, rgxStripHtml, self, validator, _, _i, _len,
    __slice = [].slice;
  ...
  if (typeof exports === 'undefined') {
    ...
    for (_i = 0, _len = importOrder.length; _i < _len; _i++) {
      module = importOrder[_i];
      _.extend(exports, require("./" + module));
    }
