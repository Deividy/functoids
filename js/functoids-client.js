...
(function() {
  var F, argumentError, delimiters, module, rgxNonWhitespace, rgxStripHtml, self, sharedFiles, validator, _, _i, _len,
    __slice = [].slice;
  ...
  if (typeof exports === 'undefined') {
    ...
    for (_i = 0, _len = sharedFiles.length; _i < _len; _i++) {
      module = sharedFiles[_i];
